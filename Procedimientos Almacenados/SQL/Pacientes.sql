...
AS
BEGIN
INSERT INTO Pacientes (PACI_apellidos,PACI_genero,PACI_fecha_nacimiento,PACI_telefono_principal,PACI_telefono_movil,PACI_direccion,PACI_ciudad,PACI_email,PACI_tarjeta_dni,PACI_numero_dni,PACI_password,PACI_rol,PACI_estado,PACI_fecha_registro)
SET @PACI_numero_dni = @@IDENTITY
VALUES (@PACI_apellidos,@PACI_genero,@PACI_fecha_nacimiento,@PACI_telefono_principal,@PACI_telefono_movil,@PACI_direccion,@PACI_ciudad,@PACI_email,@PACI_tarjeta_dni,@PACI_numero_dni,@PACI_password,@PACI_rol,@PACI_estado,@PACI_fecha_registro)
END
GO
...
BEGIN
UPDATE Pacientes
SET PACI_apellidos = @PACI_apellidos,
