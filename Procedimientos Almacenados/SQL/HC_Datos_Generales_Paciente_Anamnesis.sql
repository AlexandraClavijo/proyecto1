...
CREATE PROCEDURE SpHC_Datos_Generales_Paciente_AnamnesisInsertar
@HC_ID AS INT,
...
AS
BEGIN
INSERT INTO HC_Datos_Generales_Paciente_Anamnesis (HC_fecha_registro,HC_registro,HC_codigo,DGPA_ID,PACI_nombres,PACI_apellidos,DGPA_eps,PACI_genero,DGPA_edad,DGPA_estatura,DGPA_peso,DGPA_estado_civil,PACI_telefono_principal,PACI_email,PACI_tarjeta_dni,PACI_numero_dni,PACI_telefono_movil,PACI_direccion,PACI_ciudad)
SET @DGPA_ID = @@IDENTITY
VALUES (@HC_fecha_registro,@HC_registro,@HC_codigo,@DGPA_ID,@PACI_nombres,@PACI_apellidos,@DGPA_eps,@PACI_genero,@DGPA_edad,@DGPA_estatura,@DGPA_peso,@DGPA_estado_civil,@PACI_telefono_principal,@PACI_email,@PACI_tarjeta_dni,@PACI_numero_dni,@PACI_telefono_movil,@PACI_direccion,@PACI_ciudad)
END
GO
